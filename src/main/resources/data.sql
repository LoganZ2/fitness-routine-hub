...
-- 插入 Replies 表数据
INSERT INTO Replies (post_id, level, content, likes, created_at)
VALUES (1, 1, 'Great start!', 5, '2023-03-15T09:10:00Z');

INSERT INTO Replies (post_id, level, content, likes, created_at)
VALUES (1, 2, 'Keep it up!', 3, '2023-03-15T09:20:00Z');

INSERT INTO Replies (post_id, level, content, likes, created_at)
VALUES (2, 1, 'Thanks for the tips!', 4, '2023-03-15T09:40:00Z');

INSERT INTO Replies (post_id, level, content, likes, created_at)
VALUES (3, 1, 'I follow a similar schedule.', 2, '2023-03-15T11:10:00Z');

INSERT INTO Replies (post_id, level, content, likes, created_at)
VALUES (3, 2, 'Maybe try interval training?', 6, '2023-03-15T11:20:00Z');
